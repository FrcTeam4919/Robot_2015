...
public class OI {
    ...
    public OI() {
        ...
        button2.whileHeld(new closegrabber());
        button1 = new JoystickButton(joystick1, 1);
        button1.whileHeld(new opengrabber());
        ...
        SmartDashboard.putData("Cary can height", new Carycanheight());

        SmartDashboard.putData("Stack can on top of 4 totes height on floor", new Stackcanontopof4totesheightonfloor());

        SmartDashboard.putData("Stack can on top of 4 totes height on platform", new Stackcanontopof4totesheightonplatform());
