...
public class OI {
    ...
    public JoystickButton commandgroupa;
    public JoystickButton commandgroupb;
    public JoystickButton commandgroupc;
    public JoystickButton commandgroupd;
    ...
    public OI() {
        ...
        reset = new JoystickButton(joystick2, 3);
        reset.whileHeld(new resetcommand());
        commandgroupd = new JoystickButton(joystick2, 11);
        commandgroupd.whileHeld(new CommandGroup4());
        commandgroupc = new JoystickButton(joystick2, 10);
        commandgroupc.whileHeld(new CommandGroup3());
        commandgroupb = new JoystickButton(joystick2, 7);
        commandgroupb.whileHeld(new CommandGroup2());
        commandgroupa = new JoystickButton(joystick2, 6);
        commandgroupa.whenPressed(new CommandGroup1());
        ...
        SmartDashboard.putData("Command Group 5", new CommandGroup5());
        ...
        SmartDashboard.putData("lift to travel height auto", new lifttotravelheightauto());
