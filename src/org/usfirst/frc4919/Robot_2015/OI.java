...
public class OI {
    ...
    public OI() {
        ...
        reset = new JoystickButton(joystick2, 5);
        reset.whileHeld(new resetcommand());
        commandgroupd = new JoystickButton(joystick2, 4);
        commandgroupd.whileHeld(new CommandGroup4());
        commandgroupc = new JoystickButton(joystick2, 3);
        commandgroupc.whileHeld(new CommandGroup3());
        commandgroupb = new JoystickButton(joystick2, 2);
        commandgroupb.whileHeld(new CommandGroup2());
        commandgroupa = new JoystickButton(joystick2, 1);
        commandgroupa.whenPressed(new CommandGroup1());
        joystick1 = new Joystick(0);
        
        open = new JoystickButton(joystick1, 3);
        open.whileHeld(new opengrabber());
        close = new JoystickButton(joystick1, 1);
