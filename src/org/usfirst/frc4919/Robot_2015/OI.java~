...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("lift tote 1 height", new lifttote1height());

        SmartDashboard.putData("lift tote 2 height", new lifttote2height());

        SmartDashboard.putData("lift tote 3 height", new lifttote3height());

        SmartDashboard.putData("lift tote 4 height", new lifttote4height());

        SmartDashboard.putData("lift tote trash", new lifttotetrash());

        SmartDashboard.putData("set down", new setdown());
