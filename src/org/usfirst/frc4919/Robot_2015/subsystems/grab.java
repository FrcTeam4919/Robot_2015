...
public class grab extends Subsystem {
    ...
    Compressor compressor = RobotMap.grabCompressor;
    DoubleSolenoid rightSolenoid = RobotMap.grabRightSolenoid;
    DoubleSolenoid leftSolenoid = RobotMap.grableftSolenoid;
